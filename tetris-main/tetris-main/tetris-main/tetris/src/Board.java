...
public class Board extends JPanel {
    ...
    private int PERIOD_INTERVAL = 350;
    ...
    void start() {
        ...
        clearBoard();
        newPiece();
        statusbar.setText("Lines cleared: 0" );
    ...
    private void newPiece() {
        ...
        if (!tryMove(curPiece, curX, curY)) {
            ...
            statusbar.setText("Game over. You removed " + numLinesRemoved + " lines.");
            EventQueue.invokeLater(() -> {

                var game = new GameOver(this);
